...
const explorerDescriptionsAsset = "byteplus-sdk-metadata/explorer_descriptions/descriptions.json"
...
func getServiceDescription(service string) ServiceDescription {
	if d, ok := lookupAssetServiceDescription(service); ok {
		...
		if d.ServiceCn == "" && d.ServiceEn == "" {
			d.ServiceEn = "BytePlus " + service + " service."
		}
		return d
	}
	...
	return ServiceDescription{
		ServiceEn: "BytePlus " + service + " service.",
	}
}
